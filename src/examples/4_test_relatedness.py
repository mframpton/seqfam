import os
from relatedness.relatedness import Relatedness
import pandas as pd
...
'''Duplicates'''
print "Checking for within-family duplicates..."
wf_duplicate_l = relatedness.find_duplicates(bf_b=False)
print wf_duplicate_l
print "Checking for between-family duplicates..."
...
print "Checking expected versus observed within-family relationships..."
